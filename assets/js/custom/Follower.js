function Follower(unfollowUrl, followUrl, somethingWentWrongError, followError, unfollowError, oldNotifications = 1, newNotifications = 1,
                  ...
                  minAmountOfVisibleFollowers = 5, totalFollowing = 5, totalFollowers = 5)
{
  ...
  let oldNotificationsSize
  let newNotificationsSize
  ...
  $(function() {
    ...
    oldNotificationsSize = oldNotifications
    newNotificationsSize = newNotifications
